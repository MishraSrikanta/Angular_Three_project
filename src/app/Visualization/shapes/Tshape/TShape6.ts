...
import { Tpoints6 } from "../../Points/TshapesPoints/Tpoints6";
import { texture } from "../../Textures/Texture1";

export class TShape6 {
    constructor() { }
    static createTshape6() {
        ...
        mesh1.position.set(position[0].shape6.x, position[0].shape6.y, position[0].shape6.z)
        return mesh1;
    }
}
