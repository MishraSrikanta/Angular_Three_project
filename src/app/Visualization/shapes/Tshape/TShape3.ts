...
import { Tpoints3 } from "../../Points/TshapesPoints/Tpoints3";
import { texture } from "../../Textures/Texture1";


export class TShape3 {
    constructor() { }
    static createTshape3() {
        //#region practice of strutures like Frames
        ...
        mesh1.position.set(position[0].shape3.x, position[0].shape3.y, position[0].shape3.z)
        return mesh1;
    }
}
