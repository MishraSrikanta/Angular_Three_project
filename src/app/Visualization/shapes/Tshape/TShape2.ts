...
import { Tpoints2 } from "../../Points/TshapesPoints/Tpoints2";
import { texture } from "../../Textures/Texture1";

export class TShape2 {
    constructor() { }
    static createTshape2() {
        ...
        mesh1.position.set(position[0].shape2.x, position[0].shape2.y, position[0].shape2.z)
        return mesh1;
    }
}
