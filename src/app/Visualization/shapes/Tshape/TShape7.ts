...
import { Tpoints7 } from "../../Points/TshapesPoints/Tpoints7";
import { texture } from "../../Textures/Texture1";

export class TShape7 {
    constructor() { }
    static createTshape7() {
        ...
        mesh1.position.set(position[0].shape7.x, position[0].shape7.y, position[0].shape7.z)
        return mesh1;
    }
}
