...
import { Tpoints5 } from "../../Points/TshapesPoints/Tpoints5";
import { texture } from "../../Textures/Texture1";

export class TShape5 {
    constructor() { }
    static createTshape5() {
        ...
        mesh1.position.set(position[0].shape5.x, position[0].shape5.y, position[0].shape5.z)
        return mesh1;
    }
}
